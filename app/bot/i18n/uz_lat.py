...
STRINGS = {
    ...
    "btn_master_report": "👷 Mutaxassis hisoboti",
    "btn_usta_report": "🔨 Master hisoboti",
    "btn_export": "📥 Eksport",
    ...
    "btn_assign_usta": "👷 Master tayinlash",
    ...
    "btn_zavod_payments": "💸 Kelgan to'lovlar",
    ...
    "enter_usta_wage": "6/8 — Master ish haqi (so'm):\nMisol: <code>5000000</code>",
    ...
    "order_confirmed": "✅ <b>Zakaz muvaffaqiyatli tasdiqlandi!</b>\n\n🔢 #{number}\n⏰ Master tayinlash uchun 30 daqiqa vaqtingiz bor.\n'👷 Master tayinlash' tugmasini bosing.",
    ...
    "order_confirmed_notify": "✅ <b>Zakaz tasdiqlandi!</b>\n\n🔢 #{number}\n👷 Mutaxassis: {master}\n💰 Summa: {total} so'm\n⏰ Master tayinlash muddati: 30 daqiqa",
    "status_updated": "✅ Status yangilandi",
    "invalid_status": "❌ Noto'g'ri status",

    # ── Usta assignment ──
    "no_usta_orders": "👷 <b>Master tayinlash</b>\n\nHozircha master tayin qilinishi kerak bo'lgan zakazlar yo'q.\n(Yangi zakazni tasdiqlagandan so'ng shu yerda ko'rinadi)",
    "usta_orders_header": "👷 <b>Master tayinlash</b>\n\n{count} ta zakaz master kutmoqda.\nTanlang:",
    "no_available_ustas": "⚠️ <b>Mavjud master yo'q</b>\n\nBarcha masterlar faol emas.\n30 daqiqa o'tsa avtomatik tayinlanadi.",
    "select_usta": "👷 <b>Master tanlang</b>\n\nZakaz: #{number}\n📐 {area} m²  🏗 {asphalt}\n\nMavjud masterlar ({count} ta):",
    "usta_assigned": "✅ <b>Master tayinlandi!</b>\n\nZakaz: #{number}\n👷 Master: {master}\n\nMaster bildirishnoma oldi.",
    "usta_assigned_notify": "👷 <b>Sizga zakaz tayinlandi!</b>\n\n🔢 #{number}\n📍 {address}\n📐 {area} m²  🏗 {asphalt}\n📅 Ish sanasi: {date}\n💰 Master haqi: {wage} so'm\n\nQabul qilasizmi?",
    "back_usta_no_orders": "👷 Master tayinlanishi kerak bo'lgan zakazlar yo'q.",
    "back_usta_header": "👷 <b>Master tayinlash</b> — {count} ta zakaz:",
    ...
    "usta_accepted_notify": "✅ <b>Master zakazni qabul qildi!</b>\n\nZakaz: #{number}\n👷 Master: {master}",
    "assignment_not_yours": "❌ Bu zakaz sizga tayinlanmagan yoki allaqachon boshqa master qabul qildi.",
    "usta_declined": "❌ Zakaz rad etildi.",
    "usta_declined_notify": "❌ <b>Master zakazni rad etdi!</b>\n\nZakaz: #{number}\n👷 {master} rad etdi.\n\nYangi master tayinlang: '👷 Master tayinlash'",
    ...
    "master_report_menu": "👷 <b>Mutaxassis hisoboti</b>\n\nDavrni tanlang:",
    "master_report_empty": "👷 <b>Mutaxassis hisoboti</b> — {period}\n\nMa'lumot yo'q.",
    "master_report_header": "👷 <b>Mutaxassis hisoboti</b> — {period}\n",
    "usta_report_menu": "🔨 <b>Master hisoboti</b>\n\nDavrni tanlang:",
    "usta_report_empty": "🔨 <b>Master hisoboti</b> — {period}\n\nMa'lumot yo'q.",
    "usta_report_header": "🔨 <b>Master hisoboti</b> — {period}\n",
    ...
    "confirm_step_usta_wage": "8️⃣ Master ish haqi (so'm):\nMisol: <code>5000000</code>",
    ...
    "no_usta_pending": "👷 <b>Master tayinlash</b>\n\nHozircha master tayin qilinishi kerak bo'lgan zakazlar yo'q.\n(Yangi zakazni tasdiqlagandan so'ng shu yerda ko'rinadi)",
    "usta_assign_list": "👷 <b>Master tayinlash</b>\n\n{count} ta zakaz master kutmoqda.\nTanlang:",
    "no_ustas_available": "⚠️ <b>Mavjud master yo'q</b>\n\nBarcha masterlar band yoki faol emas.",
    "usta_assignment_notify": "👷 <b>Sizga zakaz tayinlandi!</b>\n\n🔢 #{number}\n📍 {address}\n📐 {area} m²  🏗 {asphalt}\n📅 Ish sanasi: {date}\n💰 Master haqi: {wage} so'm\n\nQabul qilasizmi?",
    "usta_assigned_success": "✅ <b>Master tayinlandi!</b>\n\nZakaz: #{number}\n👷 Master: {master}",
