...
STRINGS = {
    ...
    "btn_master_report": "👷 Отчёт мутахассисов",
    "btn_usta_report": "🔨 Отчёт мутахассисов-исполнителей",
    "btn_export": "📥 Экспорт",
    ...
    "btn_assign_usta": "👷 Назначить мутахассиса",
    ...
    "role_usta": "Мутахассис-исполнитель",
    "role_zavod": "Завод",
    ...
    "enter_usta_wage": "6/8 — Зарплата мутахассиса-исполнителя (сум):\nПример: <code>5000000</code>",
    ...
    "order_confirmed": "✅ <b>Заказ успешно подтверждён!</b>\n\n🔢 #{number}\n⏰ У вас 30 минут на назначение мутахассиса-исполнителя.\nНажмите '👷 Назначить мутахассиса'.",
    "confirm_cancel": "❌ Подтверждение отменено.",
    "confirm_error": "❌ Ошибка: заказ уже подтверждён другим или не найден.",
    "order_confirmed_notify": "✅ <b>Заказ подтверждён!</b>\n\n🔢 #{number}\n👷 Мутахассис: {master}\n💰 Сумма: {total} сум\n⏰ Срок назначения мутахассиса: 30 минут",
    "status_updated": "✅ Статус обновлён",
    "invalid_status": "❌ Неправильный статус",

    # ── Usta assignment ──
    "no_usta_orders": "👷 <b>Назначить мутахассиса</b>\n\nПока нет заказов, требующих назначения.\n(Появится после подтверждения нового заказа)",
    "usta_orders_header": "👷 <b>Назначить мутахассиса</b>\n\n{count} заказов ждут назначения.\nВыберите:",
    "no_available_ustas": "⚠️ <b>Нет доступных мутахассисов</b>\n\nВсе мутахассиса неактивны.\nЧерез 30 минут назначится автоматически.",
    "select_usta": "👷 <b>Выберите мутахассиса</b>\n\nЗаказ: #{number}\n📐 {area} м²  🏗 {asphalt}\n\nДоступные мутахассиса ({count} шт.):",
    "usta_assigned": "✅ <b>Мутахассис назначен!</b>\n\nЗаказ: #{number}\n👷 Мутахассис: {master}\n\nМутахассис получил уведомление.",
    "usta_assigned_notify": "👷 <b>Вам назначен заказ!</b>\n\n🔢 #{number}\n📍 {address}\n📐 {area} м²  🏗 {asphalt}\n📅 Дата работ: {date}\n💰 Зарплата: {wage} сум\n\nПринимаете?",
    "back_usta_no_orders": "👷 Нет заказов для назначения мутахассиса.",
    "back_usta_header": "👷 <b>Назначить мутахассиса</b> — {count} заказов:",
    ...
    "usta_accepted_notify": "✅ <b>Мутахассис принял заказ!</b>\n\nЗаказ: #{number}\n👷 Мутахассис: {master}",
    "assignment_not_yours": "❌ Этот заказ не назначен вам или уже принят другим мутахассисом.",
    "usta_declined": "❌ Заказ отклонён.",
    "usta_declined_notify": "❌ <b>Мутахассис отклонил заказ!</b>\n\nЗаказ: #{number}\n👷 {master} отклонил.\n\nНазначьте нового: '👷 Назначить мутахассиса'",
    ...
    "shofer_not_priced": "❌ Цена ещё не мастерновлена.",
    ...
    "master_report_menu": "👷 <b>Отчёт мутахассисов</b>\n\nВыберите период:",
    "master_report_empty": "👷 <b>Отчёт мутахассисов</b> — {period}\n\nДанных нет.",
    "master_report_header": "👷 <b>Отчёт мутахассисов</b> — {period}\n",
    "usta_report_menu": "🔨 <b>Отчёт мутахассисов-исп.</b>\n\nВыберите период:",
    "usta_report_empty": "🔨 <b>Отчёт мутахассисов-исп.</b> — {period}\n\nДанных нет.",
    "usta_report_header": "🔨 <b>Отчёт мутахассисов-исп.</b> — {period}\n",
    ...
    "confirm_step_usta_wage": "8️⃣ Зарплата мутахассиса-исполнителя (сум):\nПример: <code>5000000</code>",
    ...
    "no_usta_pending": "👷 <b>Назначить мутахассиса</b>\n\nПока нет заказов, требующих назначения.\n(Появится после подтверждения нового заказа)",
    "usta_assign_list": "👷 <b>Назначить мутахассиса</b>\n\n{count} заказов ждут назначения.\nВыберите:",
    "no_ustas_available": "⚠️ <b>Нет доступных мутахассисов</b>\n\nВсе мутахассиса заняты или неактивны.",
    "usta_assignment_notify": "👷 <b>Вам назначен заказ!</b>\n\n🔢 #{number}\n📍 {address}\n📐 {area} м²  🏗 {asphalt}\n📅 Дата работ: {date}\n💰 Зарплата: {wage} сум\n\nПринимаете?",
    "usta_assigned_success": "✅ <b>Мутахассис назначен!</b>\n\nЗаказ: #{number}\n👷 Мутахассис: {master}",
    ...
    "material_price_set_notify": "💰 <b>Цена на материал мастерновлена!</b>\n\n📦 {amount} тонн\n🏗 Материал: {material} сум\n🚚 Доставка: {delivery} сум\n➕ Дополнительно: {extra} сум\n💰 Итого: {total} сум\n\nДоставка организовывается.",
    "delivery_task_notify": "🚚 <b>Задание на доставку!</b>\n\n📦 {amount} тонн материала\n📝 Заказ: {order}\n\nДоставлено?",
    "price_set_success": "✅ <b>Цена мастерновлена!</b>\n\n📦 {amount} тонн — {total} сум\nМутахассис и водители уведомлены.",
    ...
    "not_priced_yet": "❌ Цена ещё не мастерновлена.",
